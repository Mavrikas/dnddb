    ...
    return (
        <Card className={styles.container}>
            <CardContent className={styles.container}>
                ...
                />
                {data.speed.walk && (
                    <LabelValue label={'Speed: Walk'} value={data.speed.walk} />
                )}
                {data.speed.burrow && (
                    <LabelValue
                        label={'Speed: Burrow'}
                ...
                {data.speed.fly && (
                    <LabelValue label={'Speed: Fly'} value={data.speed.fly} />
                )}
                {data.speed.swim && (
                    <LabelValue label={'Speed: Swim'} value={data.speed.swim} />
                )}
                <LabelValue label={'Strength'} value={data.strength} />
                <LabelValue label={'Dexterity'} value={data.dexterity} />
                <LabelValue label={'Constitution'} value={data.constitution} />
                <LabelValue label={'Intelligence'} value={data.intelligence} />
